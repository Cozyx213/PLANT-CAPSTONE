...
import com.plantfarmlogger.util.UIRenderer; // Ensure this is imported
...
public class LogCardPanel extends JPanel {
    ...
    public LogCardPanel(String notes, String date, String age, String health, String growth, String[] actions) {
        ...
        detailsPanel.add(createDetailLabel("Actions", String.join(", ", actions)));
        detailsPanel.add(createDetailLabel("Notes", notes));
